...
class TestLangfuseIntegration(unittest.TestCase):
    ...
    def test_langfuse_logo_exists(self):
        ...
        logo_path = os.path.join(
            ...
            'static', 'assets', 'logos', 'langfuse.png'
        )
        self.assertTrue(os.path.exists(logo_path), 
                       f"Langfuse logo should exist at {logo_path}")
...
class TestLangfuseStatusIntegration(unittest.TestCase):
    ...
    def test_langfuse_status_in_api_response(self):
        ...
        self.assertIsNotNone(langfuse_agent, "Langfuse agent should exist in API response")
